...
import com.sinosafe.payment.common.http.*;
...
public class HttpClientUtil {
     ...
     */
    public static HttpClient create(String url) throws HttpProcessException {
    ...
    public static String getConnection(String xmlString, String connectionUrl) throws SDKRuntimeException {
        //返回请求结果
        String info = "";
        try {
          com.mashape.unirest.http.HttpResponse<String> response = Unirest.post(connectionUrl)
                  .header("accept", "text/plain;charset=UTF-8")
                  .body(xmlString)
                  .asString();
            info = response.getBody();
        } catch (Exception e) {
            throw new SDKRuntimeException(e.getMessage() + "建立连接失败");
        }
        return info;
    }
}